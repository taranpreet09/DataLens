    ...
    <div className="font-body selection:bg-primary/30 selection:text-primary overflow-x-hidden bg-[#0e0e0e] text-white min-h-screen relative">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-outline-variant bg-surface-container-low/50 backdrop-blur-md mb-8">
              ...
              <span className="text-xs font-label uppercase tracking-widest text-on-surface-variant">Data Lens Ingestion Engine Active</span>
            </div>
            <h1 className="text-6xl md:text-8xl font-headline font-extrabold tracking-tighter leading-tight mb-8">
              ...
              Data Lens helps turn raw CSV and Excel files into clear statistics, quality checks, visualizations, and plain-English insights.
            </p>
        ...
        <section className="py-32 relative overflow-hidden">
          <div className="max-w-screen-2xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">Stop wrestling with schema definitions. Data Lens automatically detects types, relationships, and anomalies in your Excel and CSV files after upload.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[800px]">
            ...
            >
              <div>
                ...
                <h3 className="text-2xl font-headline font-bold mb-3">Data Lens Explorer</h3>
        ...
        <section className="py-32 relative">
          <div className="max-w-screen-2xl mx-auto px-4 md:px-8 flex flex-col lg:flex-row items-center gap-20">
            <motion.div 
               ...
               className="lg:w-1/2"
            >
              <h2 className="text-4xl md:text-6xl font-headline font-extrabold mb-8 tracking-tighter">Data Lens Explorer</h2>
            ...
            >
              <div className="glass-panel border border-outline-variant/30 rounded-3xl p-4 overflow-hidden data-glow hover:shadow-[0_0_40px_rgba(148,170,255,0.2)] transition-shadow duration-500">
                ...
                <div className="p-4 sm:p-6 font-mono text-xs sm:text-sm space-y-3 overflow-x-auto">
                  <div className="flex gap-4 whitespace-nowrap opacity-80"><span className="text-on-surface-variant">01</span> <span className="text-secondary">SELECT</span> insight_stream <span className="text-secondary">FROM</span> datalens_core</div>
      ...
      <footer className="w-full py-12 px-8 border-t border-slate-800/30 bg-[#0e0e0e]">
        <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-lg font-black text-slate-100 font-headline">Data Lens</div>
          ...
          <div className="text-slate-500 font-['Inter'] text-xs tracking-wide uppercase opacity-80 text-center">
            © 2024 Data Lens. All rights reserved. Precision in every pixel.
          </div>
        </div>
      </footer>
    </div>
